...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the complete outline of a course: its title, link, and the number and title of every lesson",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
    ...
    def execute(self, course_name: str) -> str:
        ...
        self.last_sources = [{"text": outline['title'], "link": outline.get('course_link')}]
        return "\n".join(lines)
